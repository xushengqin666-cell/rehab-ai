...
const DICT = {
  zh: {
    ...
    authWelcome: '欢迎使用康复AI', authTagline: '登录后数据自动同步到云端，换设备不丢失',
  ...
  en: {
    ...
    authWelcome: 'Welcome to Rehab AI', authTagline: 'Log in and your data syncs across devices automatically',
